...
func FixArrivals(raw arrivals.ArrivalRaw) arrivals.Arrival{
	...
	for idx := range out.Arrival.Services {
		...
		if(val.Line=="3"&&strings.Contains(val.Route_code, "339-")){
			val.Line="3A";
			val.Destination="S.CATERINA-MONTEFIORINO";
		}
		//3A SCUOLE MARCONI-MONTEFIORINO (Scuola)
		if(val.Line=="3"&&strings.Contains(val.Route_code, "289-")){
			val.Line="3A";
		...
		if(val.Line=="3A"&&strings.Contains(val.Route_code, "294-")){
		...
		if(val.Line=="3B"&&strings.Contains(val.Route_code, "296-")){
		...
		if(val.Line=="3B"&&strings.Contains(val.Route_code, "287-")){
		...
		if(val.Line=="3"&&(strings.Contains(val.Route_code, "407-")||strings.Contains(val.Route_code, "327-"))){
			val.Line="3A";
			val.Destination="MONTEFIORINO";
		}
		//4 POLO LEONARDO-GALILEI
		if(val.Line=="4"&&strings.Contains(val.Route_code, "MO4-As-432")){
		...
		if(val.Line=="7A"&&val.Destination=="STAZIONE FS"&&!strings.Contains(val.Route_code, "728-")){
		...
		if(val.Line=="9"&&strings.Contains(val.Route_code, "MO9-As-948")){
			val.Line="9B";
		...
		if(val.Line=="12"&&(strings.Contains(val.Route_code, "1280-")||strings.Contains(val.Route_code, "1284-"))){
			val.Line="12A";
		...
		if(val.Line=="13"&&strings.Contains(val.Route_code, "133")){
			val.Line="13F";
		}
