...
func ScrapeRouteProblems(r io.Reader) ([]model.Problem, error) {
...
func ScrapeRouteNews(url string) (model.AllNewsResponse, error) {
...
func GetSiteCode(problems []model.Problem, route string) int {
